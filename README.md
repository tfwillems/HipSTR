...
```
./HipSTR --bams          sample1.bam,sample2.bam,sample3.bam,sample4.bam 
         --indexes       sample1.bam.bai,sample2.bam.bai,sample3.bam.bai,sample4.bam.bai
...
```
* --bam :  a comma-separated list of [BAM](https://samtools.github.io/hts-specs/SAMv1.pdf) files generated by any indel-sensitive aligner (e.g. [lobSTR](http://lobstr.teamerlich.org/index.html) or [BWA-MEM](http://bio-bwa.sourceforge.net/bwa.shtml))
