...
```
* **--bam** :  a comma-separated list of [BAM](#bams) files generated by any indel-sensitive aligner (e.g. [BWA-MEM](http://bio-bwa.sourceforge.net/bwa.shtml)) and sorted and indexed using samtools
