...
The commands will construct an executable file called **HipSTR** in the current directory, for which you can view detailed help information by typing `./HipSTR --help`
...
| **--min-reads**                           | 	Minimum total reads required to genotype a locus (Default = 100) <br> **Why? Refer to the discussion**
