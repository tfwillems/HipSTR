...
namespace AlignmentFilters {
  ...
  /* Returns true iff the alignment has: 
     1) a maximal matching prefix compared to alignments that start [-max_upstream, max_downstream] from the 5' alignment position
     2) a maximal matching suffix compared to alignments that end   [-max_downstream, max_upstream] from the 3' alignment position
