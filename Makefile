...
SRC_DENOVO  = src/denovo_main.cpp src/error.cpp src/stringops.cpp src/version.cpp src/pedigree.cpp src/haplotype_tracker.cpp src/vcf_input.cpp src/denovo_scanner.cpp src/mathops.cpp src/vcf_reader.cpp
