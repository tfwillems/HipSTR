...
int main(){
  ...
  prob_b = align_pcr_insertion_forward(block_seq.size()-4, block_seq.c_str(), base_seq.size(),   base_seq.c_str(), base_log_wrong, base_log_right, 4, 2);
  ...
  prob_b = align_pcr_insertion_forward(block_seq.size()-4, block_seq.c_str(), base_seq.size()-3, base_seq.c_str(), base_log_wrong, base_log_right, 4, 2);
